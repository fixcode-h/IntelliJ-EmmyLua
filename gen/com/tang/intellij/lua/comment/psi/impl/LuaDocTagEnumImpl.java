...
public class LuaDocTagEnumImpl extends StubBasedPsiElementBase<LuaDocTagEnumStub> implements LuaDocTagEnum {

  public LuaDocTagEnumImpl(@NotNull LuaDocTagEnumStub stub, @NotNull IStubElementType<?, ?> type) {
    super(stub, type);
  }

  public LuaDocTagEnumImpl(@NotNull ASTNode node) {
    super(node);
  }

  public LuaDocTagEnumImpl(LuaDocTagEnumStub stub, IElementType type, ASTNode node) {
    super(stub, type, node);
  }

  public void accept(@NotNull LuaDocVisitor visitor) {
    visitor.visitTagEnum(this);
  }
